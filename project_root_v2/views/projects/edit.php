...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-edit me-2"></i> Modifier Projet
    </h1>
    <div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form method="post" action="index.php?controller=projects&action=update&id=<?= $project['ID_Project'] ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" 
                               value="<?= htmlspecialchars($project['Name_Project']) ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="customer_id" name="customer_id" required>
                            ...
                            <?php foreach ($customers as $customer): ?>
                                <option value="<?= $customer['ID_Customer'] ?>" 
                                    <?= $project['Customer_ID'] == $customer['ID_Customer'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contract_code" name="contract_code" 
                               value="<?= htmlspecialchars($project['contract_code']) ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="project_level" name="project_level" required>
                            <?php foreach ($projectLevels as $key => $value): ?>
                                <option value="<?= $key ?>" <?= $project['Project_Level'] == $key ? 'selected' : '' ?>>
                                    <?= $value ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="expected_ending_date" name="expected_ending_date" 
                               value="<?= $project['Expected_Ending_Date'] ?>" required>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status" name="status" required>
                            <?php foreach ($statuses as $key => $value): ?>
                                <option value="<?= $key ?>" <?= $project['Status_Project'] == $key ? 'selected' : '' ?>>
                                    <?= $value ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type_engagement" name="type_engagement" required>
                            <?php foreach ($engagementTypes as $key => $value): ?>
                                <option value="<?= $key ?>" <?= $project['Type_Engagement'] == $key ? 'selected' : '' ?>>
                                    <?= $value ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
