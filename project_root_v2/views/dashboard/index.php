                                ...
                                <?php if(isset($recentDeliverables) && count($recentDeliverables) > 0): ?>
                                    <?php foreach ($recentDeliverables as $deliverable): ?>
                                        <tr>
                                            ...
                                            <td><?= date('d/m/Y', strtotime($status['Real_Date'])) ?></td>
                                            <td>
                                                <?php if ($validation['FTR_Segula'] === 'OK'): ?>
                                                    <span class="badge bg-success">OK</span>
                                                <?php elseif ($validation['FTR_Segula'] === 'NOK'): ?>
                                            ...
                                            <td>
                                                <?php if ($validation['OTD_Segula'] === 'OK'): ?>
                                                    <span class="badge bg-success">OK</span>
                                                <?php elseif ($validation['OTD_Segula'] === 'NOK'): ?>
                                                    <span class="badge bg-danger">NOK</span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary">NA</span>
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                <?php if ($validation['FTR_Customer'] === 'OK'): ?>
                                                    <span class="badge bg-success">OK</span>
                                                <?php elseif ($validation['FTR_Customer'] === 'NOK'): ?>
                                                    <span class="badge bg-danger">NOK</span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary">NA</span>
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                <?php if ($validation['OTD_Customer'] === 'OK'): ?>
                                                    <span class="badge bg-success">OK</span>
                                                <?php elseif ($validation['OTD_Customer'] === 'NOK'): ?>
                                                    <span class="badge bg-danger">NOK</span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary">NA</span>
                                                <?php endif; ?>
